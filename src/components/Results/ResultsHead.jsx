        ...
        <form className="sorting__form">
          <fieldset className="sorting__order">
            ...
            <ul className="sorting__order-list">
              <MapMyInputs
                arr={sortingOrderFilter}
                liClassName={'sorting__order-tab'}
              />
            </ul>
          </fieldset>
...
const sortingOrderFilter = [
  {value: "popular", id: "sort-popular", innerHTML: 'Популярные', type: 'radio', name: 'sorting-order'},
  {value: "cheap", id: "sort-cheap", innerHTML: 'Дешёвые', type: 'radio', name: 'sorting-order'},
  {value: "new", id: "sort-new", innerHTML: 'Новые', type: 'radio', name: 'sorting-order'},
]